...
def DB(conn, cur):
    ...
    cur.execute('INSERT INTO Exercise (name,detail,type,ex_zone,level) VALUES ("Plancha invertida","Sientate en el suelo con las piernas juntas. Recuestate hacia atras formando un angulo de 45 grados entre el suelo y el tronco, apoyando las manos en el suelo con los brazos perpendiculares al suelo. Levanta la pelvis hacia arriba despegando el cuerpo del suelo y contrayendo los gluteos hasta formar una linea recta con el cuerpo. Debes mantener los talones apoyados en el suelo.", 1, "Torso", 3)')
    ...
    cur.execute('INSERT INTO Exercise (name,detail,type,ex_zone,level) VALUES ("Rodillazo al frente","Colocate de pie con un pie situado ligeramente detras de ti. Manten el peso sobre el pie delantero y levanta la rodilla trasera frente a ti, repite de manera alterna.", 0, "Abdominales", 0)')
