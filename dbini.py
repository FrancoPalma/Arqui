...
def DB(conn, cur):
    ...
    # nivel 3
    cur.execute('INSERT INTO Exercise (name,detail,type,ex_zone,level) VALUES ("Sentadilla con salto","Esté de pie con los pies juntos, y coloca las manos sobre los muslos. Flexiona las rodillas, salta y separa los pies en pleno salto. Déjate caer con los pies separados a una distancia mayor que los hombros, bajando hasta quedar en posicion de sentadilla", 1, "Piernas", 3)')
    ...
    cur.execute('INSERT INTO Exercise (name,detail,type,ex_zone,level) VALUES ("Plancha invertida","Sientate en el suelo con las piernas juntas. Recuestate hacia atras formando un angulo de 45º entre el suelo y el tronco, apoyando las manos en el suelo con los brazos perpendiculares al suelo. Levanta la pelvis hacia arriba despegando el cuerpo del suelo y contrayendo los glúteos hasta formar una línea recta con el cuerpo. Debes mantener los talones apoyados en el suelo.", 1, "Torso", 3)')
